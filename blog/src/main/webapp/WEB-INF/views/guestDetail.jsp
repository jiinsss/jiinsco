...
<table width='700' border='1' cellspacing='0' cellpadding=5>
  ...
  <tr>
  	<td rowspan="5"  align="center" width=300> 
  	  <img src="images/marshmallow.gif" height=200 width=300> 
  	</td>
  	<td> 사번 : ${dto.sabun}  </td>
  </tr>
  ...
  <tr align="center">
  	<td colspan="2">  
  		<a href="guestWrite.do">[등록]</a>
  		<a href="guestList.do">[출력]</a>
  		<a href="guestDelete.do?seq=${dto.seq}"> [삭제] </a>
  		<a href="guestpreEdit.do?seq=${dto.seq}"> [수정] </a>
  	</td>
  </tr>
</table> 
